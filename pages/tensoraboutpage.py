...
class TensorAboutPage(BasePage): 
    ...
    def get_working_block(self): 
        ...
        except NoSuchElementException: #отрабатывает ненахождение элемента по его XPATH
            self.make_screenshot() 
            raise ElementNotFound("Блок Работаем не обнаружен")
    ...
    def get_images_width(self): 
        ...
        return width_list #возвращает список, содержащий значения ширине у всех картинок блока Работаем
